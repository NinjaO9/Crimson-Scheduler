...
class Section:
    ...
    def __repr__(self):
        return f"Section(code={self.code}, name={self.name}, credits={self.credits}, section={self.section}, days={self.days}, location={self.location}, instructor={self.instructor}, seats_taken={self.seats_taken}, seats_total={self.seats_total})"
